...
namespace Generation.Terrain
{
    public class Tile
    {
        public static Tile floor = new Tile(WorldMain.instance.floorSprite);
        public static Tile grass = new Tile(WorldMain.instance.grassSprite);
        public static Tile wall = new Tile(WorldMain.instance.wallSprite);
        public static Tile road = new Tile(WorldMain.instance.roadSprite);
        public static List<Tile> tileTypes = new List<Tile>() { grass, floor, road, wall };

        public Sprite sprite = WorldMain.instance.grassSprite;
        public Tile() { }
