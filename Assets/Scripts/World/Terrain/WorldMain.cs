...
namespace Generation.Terrain
{
    public class WorldMain : MonoBehaviour
    {
        ...
        /// </summary>
        public readonly static int chunkSizeX = 16;
        /// <summary>
        /// How many tiles in a chunk Y
        /// </summary>
        public readonly static int chunkSizeY = 16;

        /// <summary>
        /// How many chunks in X
        /// </summary>
        public readonly static int chunkGridSizeX = 3;
        /// <summary>
        /// How many chunks in Y
        /// </summary>
        public readonly static int chunkGridSizeY = 3;
